...
public class Filters {
	...
	public void filtrapertempo(int numeromesi) throws Exception {
		...
		System.out.println("numero massimo di eventi ogni " + numeromesi + " mesi: " + max + " eventi");
		System.out.println("numero minimo di eventi ogni " + numeromesi + " mesi: " + min + " eventi");
		System.out.println("numero medio di eventi ogni " + numeromesi + " mesi:" + media + " eventi / "+numeromesi+" mesi");
	}
